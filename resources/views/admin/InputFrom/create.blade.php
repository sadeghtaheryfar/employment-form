        ...
        <div dir="rtl" class="relative overflow-x-auto">
            <form class="form-style" method="post" action="{{ route("admin.input-forms.store") }}">
                ...
                <div>
                    ...
                    <input id="title" name="title"  type="text" value="{{ old('title') }}" placeholder="عنوان ورودی را وارد کنید" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>

                <div>
                    <label for="placeholder">برچسب *</label>

                    <input id="placeholder" name="placeholder" type="text" value="{{ old('placeholder') }}" placeholder="برچسب ورودی را وارد کنید" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>

                <div>
                    <label for="name">key input *</label>

                    <input id="name" name="name"  type="text" value="{{ old('name') }}" placeholder="key input ورودی را وارد کنید" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
