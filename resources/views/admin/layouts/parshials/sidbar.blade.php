        ...
        <div class="show-menu">
            <div>
                <ul>
                    ...
                    <li class="text-white">
                        <a href="{{ route('admin.input-forms.index') }}" class="mx-[1rem] flex item-center my-[1rem]">
                            <svg width="25" height="25" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <span class="mr-[0.5rem] mt-[0.15rem]">اینپوت های فرم</span>
                        </a>
                    </li>

                    <li class="text-white">
                        <a href="{{ route('admin.recruitments.index') }}" class="mx-[1rem] flex item-center my-[1rem]">
                            <svg width="25" height="25" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z"
                    ...
                    <li class="text-white">
                        <button class="mx-[1rem] flex item-center my-[1rem]">
                            ...
                            <span class="mr-[0.5rem] mt-[0.15rem]">خروج</span>
                        </button>
                    </li>
                </ul>
            </div>
